...
class GameProvider extends ChangeNotifier {
  ...
  String _annoyedComment(String playerName) {
    final comments = [
      ...
      // Schweizerdeutsch
      '$playerName: "Hät ich gwüsst dass d\'Charte so schlecht sind, wär ich dihei bliibe."',
      '$playerName: "Das isch ja schlimmer als s\'Wätter am Zürifäscht."',
      '$playerName: "Ich ha scho besseri Charte im Abfall gseh."',
      '$playerName: "Ich glaub de Kartegäber het mich verwächslet mit em Güsel."',
      '$playerName: "Nei, eifach nei. Mach du."',
      '$playerName: "Min Hund chönnt besseri Charte uswähle."',
      '$playerName: "Ich bi russ. Macht ohne mich."',
      '$playerName: "Wer häts dänkt – schiebe isch au e Kunst."',
      '$playerName: "Die Charte sind so truurig, die bruuche Therapie."',
      '$playerName: "Kei Buur, kei Nell, kei Ass. Perfekt. Schiebe."',
      '$playerName: "Mini Charte sind wie mini Ex – enttüschend."',
      '$playerName: "Schiebe isch mis Hobby, nid mini Wahl."',
      '$playerName: "E Momänt... nei, immer no schlecht. Schiebe."',
      '$playerName: "Selbst d\'KI würd schiebe mit dene Charte."',
      '$playerName: "Das isch kei Hand, das isch e Katastrophe."',
      '$playerName: "Ich bi nid faul, mini Charte sind eifach nutzlos."',
      // Sarkastisch
      '$playerName: "Wow, was für ein Blatt. Sagte niemand. Jemals."',
      '$playerName: "Soll ich lachen oder weinen? Ich schiebe."',
      '$playerName: "Falls ihr mich sucht, ich bin beim Schieben."',
      '$playerName: "Meine Karten haben mich ghosted."',
      '$playerName: "Ist das ein Witz? Bitte sag ja."',
      '$playerName: "Ich hab schon Pokerhände gesehen die besser waren. Ohne Karten."',
      '$playerName: "Error 404: Gute Karten nicht gefunden."',
      '$playerName: "Spoiler Alert: Ich schiebe."',
      '$playerName: "Meine Karten sind so schlecht, sie wären bei Tinder nach links geswipt."',
      '$playerName: "Breaking News: Ich habe nichts."',
      '$playerName: "Diese Karten verdienen eine eigene Trauerfeier."',
      '$playerName: "Meine Reaktion: 😐 Schieben."',
      '$playerName: "Ich hab kurz überlegt. Nein."',
      // Dramatisch
      '$playerName: "O Kartengott, warum hast du mich verlassen?"',
      '$playerName: "Ich schwöre beim Buur: Diese Karten sind verflucht."',
      '$playerName: "In einer perfekten Welt hätte ich gute Karten. Diese Welt ist nicht perfekt."',
      '$playerName: "Die Tragödie des 21. Jahrhunderts: Mein Blatt."',
      '$playerName: "Shakespeare hätte über diese Karten geschrieben. Eine Tragödie."',
      '$playerName: "Ich rufe meinen Anwalt an. Das kann nicht legal sein."',
      '$playerName: "Das ist nicht Pech. Das ist persönliche Verfolgung."',
      '$playerName: "Mein Karma muss auf einem Allzeittief sein."',
      // Witzig
      '$playerName: "Ich schiebe härter als ein Staubsaugervertreter."',
      '$playerName: "Wenigstens ist die Aussicht schön. Die Karten nicht."',
      '$playerName: "Fun Fact: Man kann auch ohne gute Karten Spass haben. Aber nicht so."',
      '$playerName: "Ich bewerte meine Karten mit 1 von 5 Sternen."',
      '$playerName: "Alexa, spiele traurige Musik."',
      '$playerName: "Google Maps sagt: Nächste gute Karten in 3 Runden."',
      '$playerName: "Meine Karten sind so schlecht, sogar der Joker hat Mitleid."',
      '$playerName: "WiFi-Signal meiner Karten: kein Empfang."',
      '$playerName: "Ich schiebe – und zwar mit Nachdruck."',
      '$playerName: "Auf einer Skala von 1-10: Schieben."',
      '$playerName: "Loading... Gute Karten... Timeout. Schiebe."',
      '$playerName: "Ich brauche keine Karten. Ich brauche ein Wunder."',
      // Passiv-aggressiv
      '$playerName: "Toll gemischt. Wirklich. Danke."',
      '$playerName: "Wer auch immer gemischt hat: Wir müssen reden."',
      '$playerName: "Ich wollte eh nicht spielen. Wirklich. Ehrlich."',
      '$playerName: "Nein danke. Ich habe schon gegessen. Äh, geschoben."',
      '$playerName: "Ach wie schön, alle haben gute Karten. Ausser ich."',
      '$playerName: "Soll ich Kaffee holen während ihr spielt?"',
      '$playerName: "Geht schon, spielt ohne mich. Ich schaue zu."',
      '$playerName: "Kein Problem, ich schiebe gerne. Zum dritten Mal."',
      // Philosophisch
      '$playerName: "Schieben ist die höchste Form der Selbsterkenntnis."',
      '$playerName: "Konfuzius sagt: Wer schlechte Karten hat, soll schieben."',
      '$playerName: "Schieben ist nicht Aufgeben. Es ist strategisches Warten."',
      '$playerName: "Im Leben und im Jass: Manchmal muss man loslassen."',
      '$playerName: "Nicht ich schiebe die Karten. Die Karten schieben mich."',
      '$playerName: "Es gibt Tage zum Spielen und Tage zum Schieben. Heute ist Letzteres."',
      // Kurz und knackig
      '$playerName: "Nope."',
      '$playerName: "Haha. Nein."',
      '$playerName: "Ich schiebe."',
      '$playerName: "Ohne mich."',
      '$playerName: "Weiter."',
      '$playerName: "LOL. Schiebe."',
      '$playerName: "Nächster bitte."',
      '$playerName: "🚫"',
      '$playerName: "Isch klar. Schiebe."',
      '$playerName: "Tschüss."',
      // Essen/Trinken Referenzen
      '$playerName: "Meine Karten sind wie Raclette ohne Käse."',
      '$playerName: "So leer wie ein Fondue-Caquelon am Schluss."',
      '$playerName: "Meine Karten sind wie Rivella ohne Kohlensäure."',
      '$playerName: "Trockener als ein Zürcher Geschnetzeltes ohne Sauce."',
      '$playerName: "Ich bräuchte jetzt ein Bier. Und bessere Karten."',
      '$playerName: "Schmeckt nach Schieben heute."',
    ];
  ...
  String _postImLochComment(String announcerName, int score, String commentPlayerName) {
    final comments = [
      ...
      '$commentPlayerName: "Zwei Mal schieben und dann $score Punkte. Klassisch."',
      ...
      '$commentPlayerName: "$score Punkte nach 2× Schieben. Ich fasse es nicht."',
      ...
      '$commentPlayerName: "Nur zur Klarheit: 2× geschoben, $score Punkte geholt. Okay."',
      ...
      '$commentPlayerName: "Ich lerne: Zweimal schieben = gute Strategie. Danke, $announcerName."',
      ...
      '$commentPlayerName: "Schöne Karten, schlechtes Gewissen? Schiebe nächste Runde nicht."',
      ...
      // Schweizerdeutsch
      '$commentPlayerName: "Gopfertammi $announcerName, $score Pünkt und du hesch gschiibe?!"',
      '$commentPlayerName: "Das isch Cadeller pur. $score Pünkt ohni z\'spiele."',
      '$commentPlayerName: "$announcerName, du bisch de gröscht Cadeller wo\'s git."',
      '$commentPlayerName: "Hesch du überhaupt d\'Charte agluegt? $score Pünkt!"',
      '$commentPlayerName: "Ich glaubs nid. $score Pünkt. Und zweimal gschiibe."',
      '$commentPlayerName: "Das isch typisch $announcerName. Schiebe und denn abräume."',
      '$commentPlayerName: "Du hesch eus verarscht und mir händ\'s nid gmerkt."',
      '$commentPlayerName: "$announcerName, nächscht Mal spielsch du sofort, klar?"',
      '$commentPlayerName: "Mer redet na drüber. $score Pünkt. Unfassbar."',
      '$commentPlayerName: "Das verzeihi dir nie, $announcerName. $score Pünkt!!"',
      // Pop-Kultur
      '$commentPlayerName: "$announcerName, du bist der Plot Twist den niemand wollte."',
      '$commentPlayerName: "Netflix sollte darüber eine Doku machen. \'$score Punkte\'."',
      '$commentPlayerName: "In einem Paralleluniversum hast du sofort gespielt. Und gewonnen."',
      '$commentPlayerName: "Soundtrack zu diesem Moment: Yakety Sax."',
      '$commentPlayerName: "Das gehört auf TikTok. #Cadeller #$score"',
      '$commentPlayerName: "Oscar für die beste Vorstellung als \'schlechte Karten\': $announcerName."',
      '$commentPlayerName: "$score Punkte. Respekt. Oder Empörung. Ich bin mir nicht sicher."',
      // Kreativ
      '$commentPlayerName: "Wenn Cadeller olympisch wäre, $announcerName hätte Gold."',
      '$commentPlayerName: "Du hättest Poker spielen sollen. Dein Bluff ist perfekt."',
      '$commentPlayerName: "Ich schreibe das in mein Tagebuch: \'$announcerName hat $score Punkte gemacht. Nach 2× Schieben.\'"',
      '$commentPlayerName: "Das war nicht Glück. Das war Kalkül. Oder? ODER?!"',
      '$commentPlayerName: "$announcerName hat schlechte Karten. So wie ich Millionär bin."',
      '$commentPlayerName: "Gratuliere. Du hast das Spiel gewonnen. Und mein Vertrauen verloren."',
      '$commentPlayerName: "Ich trinke auf deine \'schlechten Karten\', $announcerName. 🍺"',
      '$commentPlayerName: "Fazit: Nie wieder $announcerName glauben."',
      '$commentPlayerName: "$score Punkte. Mein Blutdruck auch."',
      '$commentPlayerName: "Cadeller-Level: $announcerName."',
    ];
    final rng = Random().nextInt(comments.length);
    return comments[rng];
  }
